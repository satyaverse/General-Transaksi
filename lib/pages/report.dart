...
// Hanya menampilkan judul kiri dan bawah
  titlesData: FlTitlesData(
  show: true,
  leftTitles: AxisTitles(
    sideTitles: SideTitles(
      showTitles: true,
      reservedSize: 45, // beri ruang cukup
      interval: maxY / 5, // jarak antar label
  ...
  sideTitles: SideTitles(
    showTitles: true,
    interval: MediaQuery.of(context).orientation == Orientation.portrait ? 2 : 1,
    getTitlesWidget: (value, meta) {
      ...
      return Transform.rotate(
        angle: -45 * 3.1415927 / 180, // rotasi -45 derajat
        child: Text(
          "${value.toInt()}:00      ",
          style: const TextStyle(
            fontSize: 12,
...
borderData: FlBorderData(
  ...
  // List nama hari sesuai urutan tanggal
  final List<String> days = last7Days.map((date) {
          ...
          bottomTitles: AxisTitles(
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (value, meta) {
                ...
                String dayLabel = (index >= 0 && index < days.length)
                    ? days[index]
                    : "";
                return Transform.rotate(
  ...
  sideTitles: SideTitles(
    showTitles: true,
    interval: MediaQuery.of(context).orientation == Orientation.portrait ? 5 : 1,
    getTitlesWidget: (value, meta) {
      return Transform.rotate(
...
borderData: FlBorderData(
  ...
  sideTitles: SideTitles(
    ...
    getTitlesWidget: (value, meta) {
      ...
      String monthLabel = (value.toInt() >= 1 && value.toInt() <= 12)
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: const TabBar(
            indicatorColor: Colors.brown, // garis bawah tab aktif
            labelColor: Colors.brown,
            labelStyle: TextStyle(
              fontWeight: FontWeight.bold, // bold untuk tab aktif
              fontSize: 16,
            ),
            unselectedLabelStyle: TextStyle(
              fontWeight: FontWeight.normal, // normal untuk tab tidak aktif
              fontSize: 14,
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: _summaryCard(
                                  title: "Penjualan",
                                  value: _formatCurrency(todayData['penjualan'] ?? 0),
                                  color: Colors.green,
                                  subtitle: todayKey,
                                ),
                            ),
